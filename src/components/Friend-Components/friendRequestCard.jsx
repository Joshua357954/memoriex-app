...
export default function friendRequestCard({name}) {
	return (
		<div className="w-full h-16 dark:bg-gray-600 bg-gray-50 mb-[5px] rounded-md  flex justify-between px-[6px] items-center">
			...
			<div className="dark:text-gray-100 dark:bg-sky-400 text-gray-800 bg-sky-300 font-light text-xs py-3 px-2 font-bold rounded-md ">
				Add Friend
			</div>
